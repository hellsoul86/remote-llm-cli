...
func TestInferAction(t *testing.T) {
	cases := []struct {
		...
		{name: "project upsert", method: http.MethodPost, path: "/v1/projects", want: "project.upsert"},
		...
		{name: "session get", method: http.MethodGet, path: "/v1/sessions/session_1", want: "session.get"},
		{name: "session events", method: http.MethodGet, path: "/v1/sessions/session_1/events", want: "session.events.list"},
		{name: "session stream", method: http.MethodGet, path: "/v1/sessions/session_1/stream", want: "session.stream.open"},
		...
		{name: "project git status", method: http.MethodGet, path: "/v2/projects/project_1/git/status", want: "project.git.status.get"},
		{name: "project git stage", method: http.MethodPost, path: "/v2/projects/project_1/git/stage", want: "project.git.stage"},
		{name: "project git revert", method: http.MethodPost, path: "/v2/projects/project_1/git/revert", want: "project.git.revert"},
		{name: "project git commit", method: http.MethodPost, path: "/v2/projects/project_1/git/commit", want: "project.git.commit"},
